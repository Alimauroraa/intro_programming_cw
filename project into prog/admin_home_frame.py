...
def admin_home(root):
    ...
    tk.Button(
        ...
        activebackground="#B8B8B8",
        activeforeground="black",
        command=edit_volunteer_frame).place(x=286,y=400)  # this will open admin login page when clicked
    ...
    tk.Button(
        ...
        activebackground="#B8B8B8",
        activeforeground="black",
        command=allocate_resources_frame).pack(padx=50,pady=170) # this will open admin login page when clicked
