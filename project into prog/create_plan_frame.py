...
def plan_creator_frame(parent):
    ...
    geo_entry = ttk.Combobox(create_plan_frame, values=[i for i in country], width=50, state="readonly")
    start_entry = tk.Entry(create_plan_frame, width=45, bd=2, font="calibri 10")
    camps_entry = ttk.Combobox(create_plan_frame, values=list(range(1, 21)), width=50, state="readonly")
