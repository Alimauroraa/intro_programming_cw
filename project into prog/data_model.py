...
class Camp:
    def __init__(self, camp_id,volunteers,volunteer_id, location, max_capacity, specific_needs, allocatedresources, refugees, refugeeID, planname, current_availability):
        self.camp_id = camp_id
